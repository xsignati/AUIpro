...
public class SVM {
    ...
    private void gridSearch(double[]rangeC, double[]rangeGamma){
         //AUI. Prepare grids from arguments: rangeC and rangeGamma
        double[][]arrayAcc;
        int cSize;
        int gammaSize;
    ...
    public void run(String argv[], HyperParameters hyperParams) throws IOException
    {
    ...
    private static void predict(BufferedReader input, DataOutputStream output, svm_model model, int predict_probability, SVMresult svmResult) throws IOException
    {
        int correct = 0;
        int total = 0;
        double error = 0;
    ...
    public static void runPredict(String argv[], SVMresult svmResult) throws IOException
    {
